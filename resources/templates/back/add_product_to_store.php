...
<div class="col-lg-6">
    ...
    <form action="" method="post">
        <?php  add_product_to_store_first_time($store_id); ?>
        ...
        <div class="form-group col-md-12">
            ...
            <div class="input-group">
                ...
                <input type="number" name="product_quantity" class="form-control"
                       value=""
                       placeholder="00*" id="product_quantity" required>
            </div>
        </div>
        ...
        <div class="form-group col-md-12">
            ...
            <div class="input-group">
                ...
                <input type="date" name="send_date" class="form-control" value=""
                        id="" required>
            </div>
        </div>
        ...
        <div class="btn-group col-md-12">
            ...
            <button type="submit" id="add_product_to_invoice" name="add_product_to_store" class="btn btn-success"
                    value=""><span
